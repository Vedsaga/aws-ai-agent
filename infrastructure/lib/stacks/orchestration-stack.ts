...
export class OrchestrationStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: OrchestrationStackProps) {
    ...
    orchestrationRole.addToPolicy(new iam.PolicyStatement({
      ...
      resources: [`arn:aws:lambda:${this.region}:${this.account}:function:*Agent*`],
    }));
    ...
    const orchestrationLayer = new lambda.LayerVersion(this, 'OrchestrationLayer', {
    ...
    const loadPlaybookFunction = new lambda.Function(this, 'LoadPlaybookFunction', {
    ...
    const loadDependencyGraphFunction = new lambda.Function(this, 'LoadDependencyGraphFunction', {
    ...
    const buildExecutionPlanFunction = new lambda.Function(this, 'BuildExecutionPlanFunction', {
    ...
    const resultAggregatorFunction = new lambda.Function(this, 'ResultAggregatorFunction', {
    ...
    const synthesizerFunction = new lambda.Function(this, 'SynthesizerFunction', {
    ...
    const saveResultsFunction = new lambda.Function(this, 'SaveResultsFunction', {
    ...
    const definitionString = JSON.stringify(stateMachineDefinition)
      .replace(/\$\{LoadPlaybookFunctionArn\}/g, loadPlaybookFunction.functionArn)
      .replace(/\$\{LoadDependencyGraphFunctionArn\}/g, loadDependencyGraphFunction.functionArn)
      .replace(/\$\{BuildExecutionPlanFunctionArn\}/g, buildExecutionPlanFunction.functionArn)
      .replace(/\$\{AgentInvokerFunctionArn\}/g, agentInvokerFunction.functionArn)
      .replace(/\$\{ResultAggregatorFunctionArn\}/g, resultAggregatorFunction.functionArn)
      ...
      .replace(/\$\{SaveResultsFunctionArn\}/g, saveResultsFunction.functionArn);

    // Create Step Functions state machine
    this.stateMachine = new sfn.StateMachine(this, 'OrchestrationStateMachine', {
